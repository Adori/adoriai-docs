...
slug: /
title: Introduction
description: Learn how to authenticate and use the Adori AI API to generate videos, manage projects, upload media, render outputs, and automate video workflows.
---
